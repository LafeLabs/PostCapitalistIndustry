...
Proposed unit: Trash Magic kilogram is defined as the mass of one liter of water. Need to build a water balance based on distance and volume of pop bottles.  Measuring the pop bottle mass in this unit is a good first experiment to demonstrate our methods.  Fractions of a kg are measured with lever arm balance.  Write up a python notebook to work through the math of this with several examples, make weights from rocks and epoxy and grinding wheel.  Measure a rock in a sock on a string, hanging from one end of a stick, hang a known mass a known distance ratio out and compare.  Mass is made with a balance out of wood and plastic.

Need to add a table to do volumes down to picoliter 
