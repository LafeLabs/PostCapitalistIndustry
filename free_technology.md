...
itemized list of what it is not first, then what it is, then a full sketch of what a complete technological set is(so 3 sections, what is not, what is, and technological set or maybe 4 with specifics and roadmap)
